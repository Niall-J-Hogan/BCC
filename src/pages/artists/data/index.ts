export const copy =
  "We are thrilled to announce that we have received an overwhelming response to our artist applications for the upcoming tattoo convention. \n \nA heartfelt thank you to each and every talented artist who took the time to share their incredible work with us. Your passion and creativity have truly impressed us, making the selection process an inspiring journey. The anticipation is building, and we can hardly wait to unveil the exceptional lineup of artists who will be joining us for this unforgettable event. Stay tuned as we meticulously review each application to curate a lineup that reflects the diversity and excellence of the tattoo community.\n\n The countdown to an extraordinary gathering of artistic minds has begun, and we're eager to share the exciting news with you soon.";
